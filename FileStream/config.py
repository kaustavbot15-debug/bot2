...
class Telegram:
    ...
    OWNER_ID = int(env.get('OWNER_ID', '5915172170'))
    ...
    FILE_PIC = env.get('FILE_PIC', "https://i.ibb.co/DHLp2xVh/IMG-20251027-WA0002.jpg")
    START_PIC = env.get('START_PIC', "https://i.ibb.co/DHLp2xVh/IMG-20251027-WA0002.jpg")
    VERIFY_PIC = env.get('VERIFY_PIC', "https://i.ibb.co/DHLp2xVh/IMG-20251027-WA0002.jpg")
    MULTI_CLIENT = False
